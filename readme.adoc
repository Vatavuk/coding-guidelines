...
icon:comment[2x] Don't declare objects with mutable state
...
icon:comment[2x] Don't inject concrete classes to objects
...
icon:comment[2x] Don't use instanceof and type castings
...
icon:comment[2x] Think twice before creating a utility class
...
icon:comment[2x] Avoid returning NULL 
...
icon:comment[2x] Avoid passing NULL
...
icon:comment[2x] Don't use *-er* suffixes

icon:comment[2x] Don't use *-Impl* suffix
...
icon:comment[2x] Don't explain yourself using comments in code
...
icon:comment[2x] Don't use class inheritence in test suites as a way of code reuse. 

icon:comment[2x] Don't share test data between tests through class inheritance.
...
icon:comment[2x] Test names should be as descriptive as possible
...
icon:comment[2x] Reduce number of assertions per test
...
icon:comment[2x] Prefer fakes over mocks
